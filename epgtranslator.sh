...
PLUGIN_NAME="enigma2-plugin-extensions-epgtranslator"
PLUGIN_URL="https://github.com/emilnabil/download-plugins/raw/refs/heads/main/${PLUGIN_NAME}_7.5.1.ipk"
PLUGIN_FILE="/tmp/${PLUGIN_NAME}_7.5.1.ipk"

#!/bin/bash
######################################################################################
## Command=wget https://raw.githubusercontent.com/emilnabil/download-plugins/main/vavoo/vavoo.sh -O - | /bin/sh
##
###########################################
...
MY_URL="https://raw.githubusercontent.com/emilnabil/download-plugins/main/vavoo"

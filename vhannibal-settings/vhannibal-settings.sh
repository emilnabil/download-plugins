...
curl -kL --max-time 60 "https://github.com/emilnabil/download-plugins/raw/refs/heads/main/vhannibal-settings/vhannibal-settings-motor.tar.gz" -o vhannibal-settings-motor.tar.gz || { echo "Download failed"; exit 1; }

...
if [ ! -d /usr/lib64 ]; then
    ...
    PLUGINPATH=/usr/lib64/enigma2/python/Plugins/Extensions/WiFiManager
fi
...
cleanup() {
    ...
    [ -d "/tmp/WiFi-Manager-main" ] && rm -rf "/tmp/WiFi-Manager-main"
}
...
#########################################################
#       WiFiManager $version INSTALLED SUCCESSFULLY     #

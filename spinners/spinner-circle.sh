...
curl -k -L -m 60 "https://github.com/emilnabil/download-plugins/raw/refs/heads/main/spinners/spinner-circle.tar.gz" -o spinner-circle.tar.gz

if [ -s spinner-circle.tar.gz ]; then
    echo "Installing..."
    tar -xzf spinner-circle.tar.gz -C / || { echo "Extraction failed!"; exit 1; }
    sleep 1

#!/bin/bash
#
### Command=curl -kLs https://github.com/emilnabil/download-plugins/raw/refs/heads/main/spinners/spinner-aglare.sh | sh
#####################
...
curl -k -L -m 60 "https://github.com/emilnabil/download-plugins/raw/refs/heads/main/spinners/spinner-aglare.tar.gz" -o spinner-aglare.tar.gz

if [ -s spinner-aglare.tar.gz ]; then
    echo "Installing..."
    tar -xzf spinner-aglare.tar.gz -C / || { echo "Extraction failed!"; exit 1; }
    sleep 1

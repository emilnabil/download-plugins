#!/bin/bash
#
### Command=curl -kLs https://github.com/emilnabil/download-plugins/raw/refs/heads/main/spinners/spinner-nasht.sh | sh
#####################
...
curl -k -L -m 60 "https://github.com/emilnabil/download-plugins/raw/refs/heads/main/spinners/spinner-nasht.tar.gz" -o spinner-nasht.tar.gz

if [ -s spinner-nasht.tar.gz ]; then
    echo "Installing..."
    tar -xzf spinner-nasht.tar.gz -C / || { echo "Extraction failed!"; exit 1; }
    sleep 1

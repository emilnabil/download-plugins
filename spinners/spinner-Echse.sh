#!/bin/bash
#
### Command=curl -kLs https://github.com/emilnabil/download-plugins/raw/refs/heads/main/spinners/spinner-Echse.sh | sh
#####################
...
curl -k -L -m 60 "https://github.com/emilnabil/download-plugins/raw/refs/heads/main/spinners/spinner-Echse.tar.gz" -o spinner-Echse.tar.gz

if [ -s spinner-Echse.tar.gz ]; then
    echo "Installing..."
    tar -xzf spinner-Echse.tar.gz -C / || { echo "Extraction failed!"; exit 1; }
    sleep 1

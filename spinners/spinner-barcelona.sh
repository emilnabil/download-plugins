#!/bin/bash
#
### Command=curl -kLs https://github.com/emilnabil/download-plugins/raw/refs/heads/main/spinners/spinner-barcelona.sh | sh
#####################
...
curl -k -L -m 60 "https://github.com/emilnabil/download-plugins/raw/refs/heads/main/spinners/spinner-barcelona.tar.gz" -o spinner-barcelona.tar.gz

if [ -s spinner-barcelona.tar.gz ]; then
    echo "Installing..."
    tar -xzf spinner-barcelona.tar.gz -C / || { echo "Extraction failed!"; exit 1; }
    sleep 1

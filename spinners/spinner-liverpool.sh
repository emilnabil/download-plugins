#!/bin/bash
#
### Command=curl -kLs https://github.com/emilnabil/download-plugins/raw/refs/heads/main/spinners/spinner-liverpool.sh | sh
#####################
...
curl -k -L -m 60 "https://github.com/emilnabil/download-plugins/raw/refs/heads/main/spinners/spinner-liverpool.tar.gz" -o spinner-liverpool.tar.gz

if [ -s spinner-liverpool.tar.gz ]; then
    echo "Installing..."
    tar -xzf spinner-liverpool.tar.gz -C / || { echo "Extraction failed!"; exit 1; }
    sleep 1

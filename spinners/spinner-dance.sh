#!/bin/bash
#
### Command=curl -kLs https://github.com/emilnabil/download-plugins/raw/refs/heads/main/spinners/spinner-dance.sh | sh
#####################
...
curl -k -L -m 60 "https://github.com/emilnabil/download-plugins/raw/refs/heads/main/spinners/spinner-dance.tar.gz" -o spinner-dance.tar.gz

if [ -s spinner-dance.tar.gz ]; then
    echo "Installing..."
    tar -xzf spinner-dance.tar.gz -C / || { echo "Extraction failed!"; exit 1; }
    sleep 1

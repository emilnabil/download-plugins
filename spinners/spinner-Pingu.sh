#!/bin/bash
#
### Command=curl -kLs https://github.com/emilnabil/download-plugins/raw/refs/heads/main/spinners/spinner-Pingu.sh | sh
#####################
...
curl -k -L -m 60 "https://github.com/emilnabil/download-plugins/raw/refs/heads/main/spinners/spinner-Pingu.tar.gz" -o spinner-Pingu.tar.gz

if [ -s spinner-Pingu.tar.gz ]; then
    echo "Installing..."
    tar -xzf spinner-Pingu.tar.gz -C / || { echo "Extraction failed!"; exit 1; }
    sleep 1

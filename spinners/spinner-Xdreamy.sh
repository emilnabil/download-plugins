#!/bin/bash
#
### Command=curl -kLs https://github.com/emilnabil/download-plugins/raw/refs/heads/main/spinners/spinner-Xdreamy.sh | sh
#####################
...
curl -k -L -m 60 "https://github.com/emilnabil/download-plugins/raw/refs/heads/main/spinners/spinner-Xdreamy.tar.gz" -o spinner-Xdreamy.tar.gz

if [ -s spinner-Xdreamy.tar.gz ]; then
    echo "Installing..."
    tar -xzf spinner-Xdreamy.tar.gz -C / || { echo "Extraction failed!"; exit 1; }
    sleep 1

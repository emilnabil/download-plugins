#!/bin/bash
#
### Command=curl -kLs https://github.com/emilnabil/download-plugins/raw/refs/heads/main/spinners/spinner-Simba.sh | sh
#####################
...
curl -k -L -m 60 "https://github.com/emilnabil/download-plugins/raw/refs/heads/main/spinners/spinner-Simba.tar.gz" -o spinner-Simba.tar.gz

if [ -s spinner-Simba.tar.gz ]; then
    echo "Installing..."
    tar -xzf spinner-Simba.tar.gz -C / || { echo "Extraction failed!"; exit 1; }
    sleep 1

#!/bin/bash
#
### Command=curl -kLs https://github.com/emilnabil/download-plugins/raw/refs/heads/main/spinners/spinner-vu+.sh | sh
#####################
...
curl -k -L -m 60 "https://github.com/emilnabil/download-plugins/raw/refs/heads/main/spinners/spinner-vu+.tar.gz" -o spinner-vu+.tar.gz

if [ -s spinner-vu+.tar.gz ]; then
    echo "Installing..."
    tar -xzf spinner-vu+.tar.gz -C / || { echo "Extraction failed!"; exit 1; }
    sleep 1

#!/bin/bash
#
### Command=curl -kLs https://github.com/emilnabil/download-plugins/raw/refs/heads/main/spinners/spinner-girls.sh | sh
#####################
...
curl -k -L -m 60 "https://github.com/emilnabil/download-plugins/raw/refs/heads/main/spinners/spinner-girls.tar.gz" -o spinner-girls.tar.gz

if [ -s spinner-girls.tar.gz ]; then
    echo "Installing..."
    tar -xzf spinner-girls.tar.gz -C / || { echo "Extraction failed!"; exit 1; }
    sleep 1

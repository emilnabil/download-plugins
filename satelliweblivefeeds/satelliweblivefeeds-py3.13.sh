...
cd /tmp || exit
curl -k -L "https://github.com/emilnabil/download-plugins/raw/refs/heads/main/satelliweblivefeeds/satelliweblivefeeds-py3.13.tar.gz" -o /tmp/satelliweblivefeeds-py3.13.tar.gz
sleep 2

echo "Installing ...."
tar -xzf /tmp/satelliweblivefeeds-py3.13.tar.gz -C /
echo ""
echo ""

sleep 1
rm -f /tmp/satelliweblivefeeds-py3.13.tar.gz

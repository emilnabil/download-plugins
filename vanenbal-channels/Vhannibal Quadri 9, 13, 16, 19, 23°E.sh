...
ZIP_FILE="Vhannibal Quadri 9, 13, 16, 19, 23°E.zip"
...
if ! wget -q --show-progress -O "/tmp/$ZIP_FILE" "https://www.vhannibal.net/autosetting/download.php?id=4&action=download"; then

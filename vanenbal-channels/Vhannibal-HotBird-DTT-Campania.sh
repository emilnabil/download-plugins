...
ZIP_FILE="Vhannibal Hot Bird + DTT Campania.zip"
...
if ! wget -q --show-progress -O "/tmp/$ZIP_FILE" "https://www.vhannibal.net/autosetting/download.php?id=20&action=download"; then

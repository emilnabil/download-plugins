...
ZIP_FILE="Vhannibal Quadri 13, 19, 5°E, 1°W.zip"
...
if ! wget -q --show-progress -O "/tmp/$ZIP_FILE" "https://www.vhannibal.net/autosetting/download.php?id=6&action=download"; then

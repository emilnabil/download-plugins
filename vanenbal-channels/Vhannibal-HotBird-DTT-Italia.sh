...
ZIP_FILE="Vhannibal Hot Bird + DTT Italia.zip"
...
if ! wget -q --show-progress -O "/tmp/$ZIP_FILE" "https://www.vhannibal.net/autosetting/download.php?id=11&action=download"; then

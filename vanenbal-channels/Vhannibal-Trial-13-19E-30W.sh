...
ZIP_FILE="Vhannibal Trial 13, 19°E, 30°W.zip"
...
if ! wget -q --show-progress -O "/tmp/$ZIP_FILE" "https://www.vhannibal.net/autosetting/download.php?id=8&action=download"; then

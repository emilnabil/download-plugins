...
ZIP_FILE="Vhannibal Dual + DTT Italia.zip"
...
if ! wget -q --show-progress -O "/tmp/$ZIP_FILE" "https://www.vhannibal.net/autosetting/download.php?id=12&action=download"; then

...
ZIP_FILE="Vhannibal Dual + DTT Piemonte.zip"
...
if ! wget -q --show-progress -O "/tmp/$ZIP_FILE" "https://www.vhannibal.net/autosetting/download.php?id=24&action=download"; then

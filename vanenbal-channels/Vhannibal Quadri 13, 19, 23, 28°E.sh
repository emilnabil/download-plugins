...
ZIP_FILE="Vhannibal Quadri 13, 19, 23, 28°E.zip"
...
if ! wget -q --show-progress -O "/tmp/$ZIP_FILE" "https://www.vhannibal.net/autosetting/download.php?id=5&action=download"; then

...
ZIP_FILE="Vhannibal Motor + DTT Lombardia.zip"
...
if ! wget -q --show-progress -O "/tmp/$ZIP_FILE" "https://www.vhannibal.net/autosetting/download.php?id=22&action=download"; then

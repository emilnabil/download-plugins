...
ZIP_FILE="Vhannibal Dual + DTT Lombardia.zip"
...
if ! wget -q --show-progress -O "/tmp/$ZIP_FILE" "https://www.vhannibal.net/autosetting/download.php?id=18&action=download"; then

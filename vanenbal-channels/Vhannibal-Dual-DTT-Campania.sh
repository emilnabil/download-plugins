...
ZIP_FILE="Vhannibal Dual + DTT Campania.zip"
...
if ! wget -q --show-progress -O "/tmp/$ZIP_FILE" "https://www.vhannibal.net/autosetting/download.php?id=21&action=download"; then

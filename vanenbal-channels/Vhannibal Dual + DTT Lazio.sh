...
ZIP_FILE="Vhannibal Dual + DTT Lazio.zip"
...
if ! wget -q --show-progress -O "/tmp/$ZIP_FILE" "https://www.vhannibal.net/autosetting/download.php?id=15&action=download"; then

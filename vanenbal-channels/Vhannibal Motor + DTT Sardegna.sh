...
ZIP_FILE="Vhannibal Motor + DTT Sardegna.zip"
...
if ! wget -q --show-progress -O "/tmp/$ZIP_FILE" "https://www.vhannibal.net/autosetting/download.php?id=27&action=download"; then

...
ZIP_FILE="Vhannibal Motor + DTT Sicilia.zip"
...
if ! wget -q --show-progress -O "/tmp/$ZIP_FILE" "https://www.vhannibal.net/autosetting/download.php?id=26&action=download"; then

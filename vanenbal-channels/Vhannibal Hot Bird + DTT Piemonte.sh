...
ZIP_FILE="Vhannibal Hot Bird + DTT Piemonte.zip"
...
if ! wget -q --show-progress -O "/tmp/$ZIP_FILE" "https://www.vhannibal.net/autosetting/download.php?id=23&action=download"; then

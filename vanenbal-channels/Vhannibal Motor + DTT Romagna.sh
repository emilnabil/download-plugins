...
ZIP_FILE="Vhannibal Motor + DTT Romagna.zip"
...
if ! wget -q --show-progress -O "/tmp/$ZIP_FILE" "https://www.vhannibal.net/autosetting/download.php?id=28&action=download"; then

...
ZIP_FILE="Vhannibal Motor + DTT Lazio.zip"
...
if ! wget -q --show-progress -O "/tmp/$ZIP_FILE" "https://www.vhannibal.net/autosetting/download.php?id=16&action=download"; then

...
ZIP_FILE="Vhannibal Motor + DTT Italia.zip"
...
if ! wget -q --show-progress -O "/tmp/$ZIP_FILE" "https://www.vhannibal.net/autosetting/download.php?id=13&action=download"; then

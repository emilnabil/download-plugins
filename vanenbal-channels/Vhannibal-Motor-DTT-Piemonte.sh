...
ZIP_FILE="Vhannibal Motor + DTT Piemonte.zip"
...
if ! wget -q --show-progress -O "/tmp/$ZIP_FILE" "https://www.vhannibal.net/autosetting/download.php?id=25&action=download"; then

...
ZIP_FILE="Vhannibal Quadri 13, 19, 9°E, 5°W.zip"
...
if ! wget -q --show-progress -O "/tmp/$ZIP_FILE" "https://www.vhannibal.net/autosetting/download.php?id=7&action=download"; then

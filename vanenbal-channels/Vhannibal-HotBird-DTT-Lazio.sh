...
ZIP_FILE="Vhannibal Hot Bird + DTT Lazio.zip"
...
if ! wget -q --show-progress -O "/tmp/$ZIP_FILE" "https://www.vhannibal.net/autosetting/download.php?id=14&action=download"; then

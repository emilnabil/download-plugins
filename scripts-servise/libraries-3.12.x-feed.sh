...
arch=$(uname -m)
if [ "$arch" == "armv7l" ]; then
echo "src/gz 1openatv-cortexa15hf-neon-vfpv4 https://feeds2.mynonpublic.com/7.5/h7/cortexa15hf-neon-vfpv4" >>/etc/opkg/library-feed.conf
elif [ "$arch" == "mips" ]; then
echo "src/gz 1openatv-cortexa7hf-vfp https://feeds2.mynonpublic.com/7.5/sfx6008/cortexa7hf-vfp" >> /etc/opkg/library-feed.conf
fi

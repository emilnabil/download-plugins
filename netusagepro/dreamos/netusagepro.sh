...
if command -v wget >/dev/null 2>&1; then
    wget -q --no-check-certificate -O netusagepro.tar.gz "https://github.com/emilnabil/download-plugins/raw/refs/heads/main/netusagepro/dreamos/netusagepro.tar.gz"
else
    curl -k -L -o netusagepro.tar.gz "https://github.com/emilnabil/download-plugins/raw/refs/heads/main/netusagepro/dreamos/netusagepro.tar.gz"
fi
sleep 1
echo "install plugin...."
cd /tmp
